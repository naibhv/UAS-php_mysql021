...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "cookie_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "Update cookie set nama = '$nama', foto = '$foto_name', isi = '$isi', tanggal_isi = now() where id = '$id'";
        }else{
            $sql1 = "Insert into cookie(nama, foto, isi) values ('$nama','$foto_name','$isi')";
        }
...
<h1>Halaman Admin Input cookie</h1>
<div class="mb-3 row">
    <a href="halaman.php">Kembali Ke Halaman Admin cookie</a>
</div>
<?php
if ($error) {
    ?>
